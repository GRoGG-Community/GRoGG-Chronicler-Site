...
import { TREATY_STATUS_OPTIONS } from '../../../../business/utils/treatyUtils';
import ActionButton from '../../common/ActionButton';
import ModalOverlay from '../../empire/ModalOverlay';
...
export default function TreatyDialog({ open, mode, data, onSave, onClose, error, saving, empires, accounts, account }) {
    ...
    return (
        <ModalOverlay onClose={onClose}>
            <div className="treaty-edit-dialog">
                <div className="treaty-edit-form">
                    <h2>{isEdit ? 'Edit Treaty' : 'New Treaty'}</h2>
                    <form onSubmit={e => { e.preventDefault(); onSave(form); }}>
                        <div className="treaty-edit-header">
                        ...
                        <div className="treaty-edit-participants">
                        ...
                        >
                            <span style={{
                                ...
                                {form.participants.length
                                    ? cutOffDotter.cut(form.participants.join(', '), TEXT_LIMITS.PARTICIPANT_DROPDOWN_PREVIEW)
                                    : 'Select participants...'}
                            </span>
                                ...
                                {empires.map((e, idx) => (
                                    ...
                                    >
                                        ...
                                        <span style={{
                                            ...
                                            {cutOffDotter.cut(e, TEXT_LIMITS.PARTICIPANT_ITEM_PREVIEW)}
                                        </span>
                                    </button>
                                ))}
                            </div>
                ...
                <div className="treaty-edit-content-section">
                    <div className="treaty-edit-content-field">
                        <label
                    ...
                    <div className="treaty-edit-preview">
                        <MarkdownRenderer markdown={form.content} />
                    </div>
                </div>
                {error && <ErrorMessage>{error}</ErrorMessage>}
                <div className="treaty-edit-actions">
